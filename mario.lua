...
function mario:globalcollide(a, b, c, d, dir)
	...
	if mariocoincount >= 99 then
			if mariolivecount ~= false then
				...
				mariocoincount = mariocoincount - 99
				playsound("oneup")
				return true
		else 
	...
	elseif b.givesdecacoin then
		if mariocoincount >= 90 then
			if mariolivecount ~= false then
					for i = 1, players do
						mariolives[i] = mariolives[i] + 1
						respawnplayers()
				...
				mariocoincount = mariocoincount - 90
				playsound("oneup")
				return true
		else 
			mariocoincount = mariocoincount + 10
			playsound("decacoin")
			return true
		end
